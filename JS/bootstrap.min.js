      ...
      (a.prototype.close = function (t) {
        ...
        t && t.preventDefault(),
          ...
          t.isDefaultPrevented() ||
            (o.removeClass("in"), s.support.transition && o.hasClass("fade") ? o.one("bsTransitionEnd", n).emulateTransitionEnd(a.TRANSITION_DURATION) : n());
      });
    var t = s.fn.alert;
            ...
            s.proxy(function () {
              i[o](null == n[t] ? this.options[t] : n[t]),
                "loadingText" == t
                  ...
                  : this.isLoading && ((this.isLoading = !1), i.removeClass(e).removeAttr(e).prop(e, !1));
            }, this),
            0
          );
      }),
        ...
        if (!e.is(".disabled, :disabled")) {
          ...
          if ((s(), !o)) {
            "ontouchstart" in document.documentElement &&
              ...
              a(document.createElement("div")).addClass("dropdown-backdrop").insertAfter(a(this)).on("click", s);
        ...
        t && t.preventDefault(),
          ...
          this.isShown &&
            ...
            a.support.transition && this.$element.hasClass("fade")
              ? this.$element.one("bsTransitionEnd", a.proxy(this.hideModal, this)).emulateTransitionEnd(s.TRANSITION_DURATION)
              : this.hideModal());
      }),
    ...
    (m.VERSION = "3.4.1"),
      ...
      (m.prototype.init = function (t, e, i) {
        if (
          ...
          (this.$viewport =
            ...
            g(document).find(
              g.isFunction(this.options.viewport) ? this.options.viewport.call(this, this.$element) : this.options.viewport.selector || this.options.viewport
            )),
      ...
      (m.prototype.setContent = function () {
        var t = this.tip(),
          e = this.getTitle();
        this.options.html
          ? (this.options.sanitize && (e = n(e, this.options.whiteList, this.options.sanitizeFn)), t.find(".tooltip-inner").html(e))
      ...
      (m.prototype.toggle = function (t) {
        ...
        t &&
          ((e = g(t.currentTarget).data("bs." + this.type)) ||
            ((e = new this.constructor(t.currentTarget, this.getDelegateOptions())), g(t.currentTarget).data("bs." + this.type, e))),
